...
@Autonomous
public class CameraLoc extends LinearOpMode {
    VitiTawiti robot;
    @Override
    ...
    private void telemetryTfod() {
        ...
        List<Recognition> currentRecognitions = robot.tf.getRecognitions();
    ...
    private void telemetryAprilTag() {
        ...
        List<AprilTagDetection> currentDetections = robot.atag.getDetections();
